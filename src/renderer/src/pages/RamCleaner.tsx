...
export default function RamCleaner(): React.ReactElement {
  ...
  const [cleanResult, setCleanResult] = useState<{ success: boolean; message?: string } | null>(
    null
  )
  ...
  const handleClean = async () => {
    ...
    try {
      ...
      setCleanResult({
        success: false,
        message: e.message || 'Wystąpił błąd krytyczny komunikacji.'
      })
    } finally {
      setCleaning(false)
    ...
    <div className="page-container" style={{ padding: '24px', height: '100%', overflowY: 'auto' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ color: 'var(--color-text-muted)', fontSize: '13px', margin: 0 }}>
          Oczyszczaj listę oczekującą (Standby Memory Cache) oraz obszary robocze procesów, aby
          zapobiec mikroprzycięciom w grach i aplikacjach.
        </p>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '20px' }}>
                ...
                <div>
                  ...
                  >
                    <span style={{ color: 'white', fontWeight: 500 }}>
                      Lista oczekująca (Standby Cache)
                    </span>
                    <span style={{ color: 'var(--color-secondary)' }}>
                      {toGB(stats.standby)} GB ({standbyPct}%)
                    </span>
                  </div>
                  <div
                    style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            >
              ...
              >
                Wybierz typ optymalizacji, a następnie kliknij przycisk poniżej. System wymusi monit
                UAC (uprawnienia administratora), aby wywołać natywne API jądra Windows.
              </p>
              ...
              >
                ...
                >
                  ...
                  <div>
                    <strong style={{ display: 'block' }}>
                      Zwolnij Listę Oczekującą (Standby Cache)
                    </strong>
                    <span style={{ fontSize: '10px', color: 'var(--color-text-muted)' }}>
                      Bezpieczne oczyszczenie buforów i cache systemowego.
                    </span>
                  </div>
                </label>
                ...
                >
                  ...
                  <div>
                    <strong style={{ display: 'block' }}>
                      Wyczyść Zestawy Robocze (Working Sets)
                    </strong>
                    <span style={{ fontSize: '10px', color: 'var(--color-text-muted)' }}>
                      Wymusza na procesach tła zrzucenie nieużywanych danych do pliku stronicowania.
                    </span>
                  </div>
                </label>
                ...
                >
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '10px', color: 'var(--color-text-muted)' }}>
                      Wykonywane są obie powyższe procedury naraz w celu maksymalnego odzyskania
                      RAM.
                    </span>
                  </div>
                </label>
              ...
              {cleanResult && (
                <div
                  style={{
                    ...
                    borderRadius: '10px',
                    fontSize: '12px',
                    background: cleanResult.success
            ...
            >
              ...
              {staticHardware &&
              Array.isArray(staticHardware.layout) &&
              staticHardware.layout.length > 0 ? (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <strong style={{ color: 'white' }}>
                          {(module.size / (1024 * 1024 * 1024)).toFixed(0)} GB
                        </strong>
                      </div>
                      <div>
                        <span style={{ color: 'var(--color-text-muted)', display: 'block' }}>
                      ...
                      <div>
                        ...
                        <strong style={{ color: 'white' }}>
                          {module.clockSpeed || 'Nieznane'} MHz
                        </strong>
                      </div>
                      <div>
                        <span style={{ color: 'var(--color-text-muted)', display: 'block' }}>
