...
export function Network() {
  ...
  const handleToggleDoh = async (interfaceGuid: string, dnsIps: string[], enable: boolean) => {
    setTogglingDoh(true)
    appendLog(
      `Zmienianie statusu DNS-over-HTTPS (DoH) na ${enable} dla adaptera ${interfaceGuid}...`
    )
        ...
        <div className="grid-panels">
          ...
          <div className="glass-panel main-panel">
            ...
            <div className="dns-list flex flex-col gap-sm">
              ...
              {(() => {
                const currentAdapterDoh = dohStatus.find(
                  (i) => i.interfaceIndex === Number(selectedInterfaceIndex)
                )
                return (
                  <div
                    className="glass-panel mt-md"
                    style={{
                      padding: '16px',
                  ...
                  >
                    <div className="flex justify-between items-center mb-sm">
                      <h3
                        className="flex items-center gap-xs text-xs font-bold uppercase text-white animate-fade-in"
                        style={{ margin: 0 }}
                      >
                    ...
                    {!selectedInterfaceIndex ? (
                      <p className="text-xs text-muted" style={{ margin: 0 }}>
                        Wybierz kartę sieciową, aby skonfigurować szyfrowanie DNS.
                      </p>
                      ...
                      >
                        <span className="text-[10px] font-bold text-warning uppercase">
                          Wymagany Statyczny DNS
                        </span>
                        <p
                          className="text-[11px] text-muted"
                          style={{ margin: 0, lineHeight: 1.4 }}
                        >
                          Karta sieciowa pobiera DNS automatycznie (DHCP). Włącz jeden z gotowych
                          profili DNS (np. Cloudflare lub Google) powyżej, aby móc aktywować
                          szyfrowane połączenie DoH.
                        </p>
                      </div>
                    ) : currentAdapterDoh &&
                      currentAdapterDoh.dns &&
                      currentAdapterDoh.dns.length > 0 ? (
                      <div className="flex flex-col gap-sm">
                        <p
                          className="text-[11px] text-muted"
                          style={{ margin: 0, lineHeight: 1.4 }}
                        >
                          Szyfruj zapytania DNS, aby uniemożliwić szpiegowanie odwiedzanych domen
                          (DNS Spoofing) na poziomie sieci lokalnej i ISP.
                        </p>
                            ...
                            >
                              <div className="flex flex-col">
                                ...
                                <span className="text-[10px] text-muted">
                                  {dnsItem.dohActive
                                    ? 'Szyfrowanie DoH (HTTPS) Aktywne 🔒'
                                    : 'Transmisja Odkryta (UDP/TCP) 🔓'}
                                </span>
                              </div>
                              ...
                              <button
                                ...
                                onClick={() =>
                                  handleToggleDoh(
                                    currentAdapterDoh.interfaceGuid,
                                    currentAdapterDoh.dns.map((d) => d.ip),
                                    !dnsItem.dohActive
                                  )
                                }
                      ...
                      <p className="text-xs text-muted" style={{ margin: 0 }}>
                        Brak skonfigurowanych serwerów DNS na tym interfejsie.
                      </p>
                    )}
                  </div>
                )
                    ...
                    <div className="flex items-center gap-xs">
                      ...
                      <span
                        ...
                        style={{
                          ...
                          height: '6px',
                          borderRadius: '50%',
                          backgroundColor: hardening.llmnrDisabled ? '#34d399' : '#fb923c'
                        }}
                      />
                    </div>
                    <p
                      className="text-[10px] text-muted"
                      style={{ margin: '2px 0 0 0', lineHeight: 1.4 }}
                    >
                      Blokuje rozgłaszanie nazw lokalnych (Link-Local Multicast Name Resolution) w
                      sieci.
                    </p>
                  </div>
                  <button
                    ...
                    <div className="flex items-center gap-xs">
                      ...
                      <span
                        ...
                        style={{
                          ...
                          height: '6px',
                          borderRadius: '50%',
                          backgroundColor: hardening.netbiosDisabled ? '#34d399' : '#fb923c'
                        }}
                      />
                    </div>
                    <p
                      ...
                      style={{ margin: '2px 0 0 0', lineHeight: 1.4 }}
                    >
                      Wyłącza NetBIOS over TCP/IP dla kart sieciowych. Zapobiega wyciekom skrótów
                      NTLM.
                    </p>
                  </div>
                  <button
                    ...
                    onClick={() =>
                      handleToggleHardening('netbiosDisabled', !hardening.netbiosDisabled)
                    }
                    disabled={loadingHardening}
                    style={{
                      padding: '4px 10px',
